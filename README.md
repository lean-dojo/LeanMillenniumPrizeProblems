> **Deprecated:** This branch (`old_main`) is kept only for historical reference / old resources.
> Please use the `main` branch for the current Clay-aligned, `sorry`-free formalizations.
