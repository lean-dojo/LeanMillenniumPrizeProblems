...
// Module: Problems.NavierStokes.MillinieumRDomain
// Imports: Init Problems.NavierStokes.Imports Problems.NavierStokes.Sobolev Problems.NavierStokes.Definitions Problems.NavierStokes.Navierstokes
#include <lean/lean.h>
...
lean_object* initialize_Problems_NavierStokes_Sobolev(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Problems_NavierStokes_MillinieumRDomain(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Problems_NavierStokes_Sobolev(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
