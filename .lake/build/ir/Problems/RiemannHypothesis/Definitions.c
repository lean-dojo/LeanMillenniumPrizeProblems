...
// Module: Problems.RiemannHypothesis.Definitions
// Imports: Init Mathlib.Data.Fin.Basic Mathlib.Analysis.Calculus.FDeriv.Basic Mathlib.Analysis.Calculus.Deriv.Basic Mathlib.Analysis.Calculus.LineDeriv.Basic Mathlib.Analysis.Calculus.Deriv.Add Mathlib.Data.Matrix.Basic Mathlib.LinearAlgebra.Basis.Defs Mathlib.Data.Real.Basic Mathlib.Analysis.InnerProductSpace.PiL2 Problems.RiemannHypothesis.AdjointSpace
#include <lean/lean.h>
...
lean_object* initialize_Problems_RiemannHypothesis_AdjointSpace(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Problems_RiemannHypothesis_Definitions(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Problems_RiemannHypothesis_AdjointSpace(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
